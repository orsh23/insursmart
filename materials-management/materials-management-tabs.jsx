import React from 'react';
    ...
    import { Package, ListChecks, ShoppingCart } from 'lucide-react'; // Example icons

    // Import tab components
    import MaterialsTab from './materials-tab'; 
    import MaterialsBoMsTab from './boms-tab'; // Updated name for MaterialsBoM
    // import MaterialCategoriesTab from './MaterialCategoriesTab'; // Placeholder for future
    ...
    export default function MaterialsManagementTabs() {
      ...
      const tabsConfig = [
        ...
        },
        {
          ...
          icon: ListChecks,
          component: <MaterialsBoMsTab />, // Use the MaterialsBoM specific tab
        },
        // {
        //   value: 'categories',
        //   labelKey: 'materialsManagement.tabs.categories',
        //   defaultLabel: 'Categories',
        //   icon: ShoppingCart, // Example
        //   component: <MaterialCategoriesTab />, // Placeholder
        //   disabled: true,
        // },
      ];
